...
import { Home, Search, Trophy, ChevronDown, ChevronUp } from 'lucide-react';
...
export default function Sidebar() {
    ...
    return (
        <div className="fixed left-0 top-0 h-screen w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 p-4">
            {/* Logo */}
